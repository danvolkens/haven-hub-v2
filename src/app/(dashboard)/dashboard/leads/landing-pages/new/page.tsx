...
export default function NewLandingPagePage() {
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      toast('Landing page created successfully!', 'success');
      router.push('/dashboard/leads/landing-pages');
    } catch (error) {
      toast(error instanceof Error ? error.message : 'Failed to create landing page', 'error');
    } finally {
  ...
  return (
    <PageContainer
      ...
      description="Build a lead capture landing page"
      actions={
    ...
    >
      <div className="max-w-3xl space-y-6">
        ...
        <Card>
          <CardHeader
            title="Form Fields"
            description="Configure the fields visitors will fill out"
          />
          <CardContent className="space-y-4">
